...
public class AgoraCustomTextureRenderer implements IVideoSink, TextureView.SurfaceTextureListener {
    ...
    public AgoraCustomTextureRenderer(Context context, TextureView view) {
        mTextureView = view;
